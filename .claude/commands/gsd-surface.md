...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/trading/.claude/.gsd-surface.json`
(sibling to `/home/user/trading/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/trading/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/trading/.claude/skills`).
...
`/home/user/trading/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/trading/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/trading/.claude/.gsd-surface.json`
Install profile marker: `/home/user/trading/.claude/.gsd-profile`
Skill dirs: `/home/user/trading/.claude/skills/gsd-*/`
Engine module: `/home/user/trading/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/trading/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
