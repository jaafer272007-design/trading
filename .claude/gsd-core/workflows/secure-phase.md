...
```
Agent(
  prompt="Read /home/user/trading/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/trading/.claude/gsd-core/templates/SECURITY.md`
