...
```markdown
Read /home/user/trading/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/trading/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/trading/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/user/trading/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/user/trading/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/user/trading/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/user/trading/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
